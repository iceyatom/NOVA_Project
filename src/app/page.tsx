...
export default function HomePage() {
  return (
    <div className="three-pane">
      ...
      {/* NOTE: .home-hero lets CSS override .hero-title color/size to match the original Home styling (black). */}
      <section className="pane pane-center home-hero" aria-labelledby="hero-heading">
