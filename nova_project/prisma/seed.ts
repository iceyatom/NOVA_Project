...
async function main() {
  ...
  for (const article of articles) {
    await prisma.article.create({
      data: {
        ...article,
        type: article.type as "INFO" | "NEWS",
      },
    });
  }
}
