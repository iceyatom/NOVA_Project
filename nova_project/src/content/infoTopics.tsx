...
export const infoTopicsByKey: Record<string, InfoTopic> = {
  "owl-pellets": {
    ...
    body: (
      <div>
        <p>
          ...
          regurgitated. These fascinating educational tools provide students
          with a hands-on opportunity to dissect and study the skeletal remains
          of small animals.
        </p>
        <p>
          Our owl pellets are professionally cleaned, heat-sterilized, and
          individually wrapped. They&apos;re perfect for classroom studies of
          predator- prey relationships, skeletal anatomy, and ecosystem
          dynamics.
        </p>
    ...
    images: ["/images/owl-pellets-1.jpg", "/images/owl-pellets-2.jpg"],
  },
    ...
    body: (
      <div>
        <p>
          ...
          ensure viability and educational value. Perfect for studying
          photosynthesis, cellular structure, and aquatic ecosystems.
        </p>
        <p>
          Each culture is prepared with detailed care instructions and can be
          used for a variety of experiments including population studies,
          environmental impact assessments, and cellular biology investigations.
        </p>
      </div>
    ),
  ...
  "live-invertebrates": {
    ...
    body: (
      <div>
        <p>
          Explore the fascinating world of invertebrates with our live
          specimens. From insects to mollusks, these organisms provide endless
          opportunities for behavioral and anatomical studies.
        </p>
      </div>
    ),
    ...
    body: (
      <div>
        <p>
          ...
          understand microbial growth, colony morphology, and antimicrobial
          effects.
        </p>
      </div>
    ),
    ...
    body: (
      <div>
        <p>
          ...
          single-celled organisms are perfect for microscopy studies and
          understanding cellular processes in action.
        </p>
      </div>
    ),
    ...
    body: (
      <div>
        <p>
          ...
          allow for detailed anatomical study without the need for special
          housing.
        </p>
      </div>
    ),
